...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    //     $selected_space = $_POST['space'];
    //     echo "<h2>飲食店の雰囲気:</h2>";
    //     echo "<ul>";
    //     foreach ($selected_space as $space) {
    //         if ($space == "Other" && !empty($_POST['other_space'])) {
    //             echo "<li>その他: " . htmlspecialchars($_POST['other_space']) . "</li>";
    //         } else {
    //             echo "<li>" . htmlspecialchars($space) . "</li>";
    //         }
    //     }
    //     echo "</ul>";
    // } else {
    //     echo "<h2>飲食店の雰囲気が選択されていません。</h2>";
    // }
